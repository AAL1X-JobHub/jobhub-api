...
import com.al1x.jobhub.security.JWTConfigurer;
import com.al1x.jobhub.security.JWTFilter;
import com.al1x.jobhub.security.JWTAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(antMatcher("/users/create")).permitAll()
                        .requestMatchers(antMatcher("/jobs/read/**")).permitAll()
                        .requestMatchers(antMatcher("/mails/**")).permitAll()
