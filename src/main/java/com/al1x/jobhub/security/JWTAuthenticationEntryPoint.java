...
import com.al1x.jobhub.exception.CustomErrorResponse;
...
public class JWTAuthenticationEntryPoint implements AuthenticationEntryPoint {
    ...
    // TODO: Este método se ejecuta cuando un usuario no autenticado intenta acceder a un recurso que requiere autenticación
    @Override
    public void commence(HttpServletRequest request, HttpServletResponse response, AuthenticationException authException)
        ...
        CustomErrorResponse errorResponse = new CustomErrorResponse(exceptionMsg, response.getStatus(), request.getRequestURI());
    ...
    // TODO :Método auxiliar para convertir el objeto de error en un JSON para incluirlo en la respuesta HTTP
